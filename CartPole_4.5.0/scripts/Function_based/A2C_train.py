...
from RL_Algorithm.Function_based.A2C import Actor_Critic
...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlOnPolicyRunnerCfg):
    ...
    while simulation_app.is_running():
        ...
        for episode in tqdm(range(n_episodes)):
            reward, step, log_info = agent.learn(env, max_steps=1000, num_agents=1)
            ...
            wandb.log({
                "sum_reward": reward,
                "count": step,
                "actor_loss": log_info["actor_loss"],
                "critic_loss": log_info["critic_loss"],
                "episode": episode
            }, step=episode)
